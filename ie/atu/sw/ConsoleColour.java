...
/**
 * ConsoleColour enum class is responsible for the colour options available for the user interface
 */
public enum ConsoleColour {
     ...
     * 
     * <p> The running time is O(1) as it returns the control sequence introducer</p>
     * @param description The description of the colour
     * @param colour      The colour code
     * @return The control sequence introducer
     * @param code        The colour code
     */
     ...
     * <p> The running time is O(1) as it returns the description of the colour</p>
     * @param description The description of the colour
    ...
    /**
     * Returns the colour
     * <p> The running time is O(1) as it returns the colour</p>
     ...
     * <p> The running time is O(1) as it gets the colour code</p>
     * @param code The colour code
